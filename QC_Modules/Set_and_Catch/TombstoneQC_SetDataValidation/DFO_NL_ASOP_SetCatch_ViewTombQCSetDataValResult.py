...
def ViewTombQCSetDataFailResult():
    window = tk.Tk()
    window.title ("DFO-NL-ASOP TombstoneQC & Set Data Validation - ID-E-01")
    ...
    def UpdateDeploymentUIDAfterUpdate():
        ...
        SetCatchQCFailedDB_DF.to_sql('DFO_NL_ASOP_Set_Catch_Analysis_IMPORT', 
