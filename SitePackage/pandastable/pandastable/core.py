...
class Table(Canvas):
    ...
    def sortTable(self, columnIndex=None, ascending=1, index=False):
        ...
        if index == True:
            ...
            if colnames == ['DeploymentUID']:
                print('could not sort- Use DropDown Sort From Widget')
        self.redraw()
        return
    ...
    def prodyutCustomsetindex(self):
        """Set indexes"""
    ...
    def prodyutCustomsetindex1(self):
        """Set indexes"""
    ...
    def prodyutCustomsetindex2(self):
        """Set indexes"""
    ...
    def prodyutCustomsetindex2_1(self):
        """Set indexes"""
    ...
    def prodyutCustomsetindex5_2(self):
        """Set indexes"""
    ...
    def prodyutCustomsetindex3(self):
        """Set indexes"""
    ...
    def prodyutCustomgetSelColName(self):
        cols = self.multiplecollist
        return cols
    ...
    def prodyutcustomAddUpdate(self):
        """Make copy of rows"""
    ...
    def prodyutCustomclearTable(self):
        self.storeCurrent()
        model = TableModel(pd.DataFrame())
        self.updateModel(model)
        self.redraw()
    ...
    def saveAs(self, filename=None):
        ...
        if filename == None:
            filename = filedialog.asksaveasfilename(parent=self.master,defaultextension='.csv',
                                                     initialdir = self.currentdir,
                                                     filetypes=[("csv","*.csv"),("pickle","*.pickle"),
                                                                ("All files","*.*")])
        if filename:
