...
def ExcelViewDB_QCAnalysis_SetCatch():
    windows = tk.Toplevel()
    windows.title ("Excel Table View Observer Set & Catch QC Database - B-02")
    ...
    def SubmitToUpdateDB():
        ...
        if len(Complete_df) >0:
            ...
            if iSubmit >0:
                ...
                if len(Complete_df) > 25000:
                    try:
                        BackendSubmitAndUpdateDB_Replace(Complete_df)
                    except:
